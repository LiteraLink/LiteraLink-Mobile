...
//for animation
  ...
  Future<List<Venue>>? _venueFuture; // Variabel buat nyimpen hasil fetchVenue
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      Visibility(
        visible: loggedInUser.role ==
            'A', // Menentukan visibilitas berdasarkan peran pengguna
                          ...
                          child: Wrap(
                            children: <Widget>[
                              Container(
                                  ...
                                  child: Column(
                                    children: [
                                      addVenueField(_placeNameController,
                                          "Venue", _formKey, null),
                                      addVenueField(_addressController,
                                          "Address", _formKey, null),
                                      addVenueField(_venueOpenController,
                                          "Jam Buka", _formKey, null),
                                      addVenueField(_rentBookController,
